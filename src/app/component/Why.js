    ...
    <section className="section flex items-center" id="why">
      <div className="container mx-auto">
        ...
        >
          ...
          the competition. From thr moment you engage with us, we strive to
        ...
        <motion.div
          ...
          className="flex flex-wrap justify-center gap-4 xl:grid 
                     xl:grid-cols-3 xl:gap-y-0 xl:gap-x-[30px]"
        >
          {/* item 1 */}
          <div
          ...
          >
            ...
            <p className="hidden xl:flex">
              ...
              experience with us us nothing short of outstanding.
            </p>
          </div>
          {/* item 2 */}
          <div
